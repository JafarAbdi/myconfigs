---
name: tiger-style
description: ALWAYS load before writing, editing, reviewing, or refactoring code in any language. Applies TigerBeetle TigerStyle principles for simplicity, safety, performance, and developer experience.
---
