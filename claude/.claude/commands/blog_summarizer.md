...
- Key points (short bullets, one line each)
- Notable quotes, stats, or examples (only if they actually add something)
- Actionable takeaways (only if there are any)

Rules:

- No intro, no "this post is about...", no warmup
- Drop the fluff, anecdotes, and stuff the author repeats
- If a section has nothing worth keeping, just leave it out
